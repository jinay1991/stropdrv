...
static DEFINE_MUTEX(chardrv_mutex); // macro to declare a new mutex 
...
static int Dev_Open(struct inode *i, struct file *f)
{
	...
	if(!mutex_trylock(&chardrv_mutex))
	{
